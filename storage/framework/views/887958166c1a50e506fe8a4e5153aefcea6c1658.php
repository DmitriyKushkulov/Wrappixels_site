                ...
                <div class="col-md-2 offset-md-1">
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="list-style:none;">
                            <a class="text-white line-height-base" href="<?php echo e(URL::to('/blog')); ?>"><?php echo e(Helper::translation(2877,$translate)); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <div class="btn_text">
                                    ...
                                    <a href="<?php echo e(URL::to('/single')); ?>/<?php echo e($post->post_slug); ?>" class="btn btn--md btn-outline-accent"><?php echo e(Helper::translation(2878,$translate)); ?></a>
                                </div>
                            </figcaption>
                        </figure>
                    </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\wrappixels\resources\views/blog.blade.php ENDPATH**/ ?>