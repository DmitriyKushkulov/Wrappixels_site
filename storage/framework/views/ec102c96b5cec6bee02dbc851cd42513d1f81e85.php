        ...
        <div class="container content_above mb-lg-3 pb-4 pt-5">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <?php echo e(Helper::translation(2931,$translate)); ?>
                ...
                <div class="col-md-3 offset-md-1">
                    <ul class="breadcrumb">
                        ...
                        <li style="list-style:none;">
                            <a class="text-white line-height-base" href="<?php echo e(URL::to('/upload-item')); ?>"><?php echo e(Helper::translation(2931,$translate)); ?> /</a>
                        </li>
                        <li class="active" style="list-style:none;">
                           
                            <a class="text-white line-height-base" href="#"> <?php echo e($type_name->item_type_name); ?></</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\wrappixels\resources\views/upload-item.blade.php ENDPATH**/ ?>