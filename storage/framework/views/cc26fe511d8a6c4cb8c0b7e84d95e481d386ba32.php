<header class="bg-light box-shadow-sm navbar-sticky">
    <div class="topbar topbar-dark bg-dark">
        <div class="container">
            ...
            <div class="topbar-text text-nowrap d-none d-md-inline-block col-lg-6 col-md-6">
            </div>
            <div class="col-lg-6 col-md-6 text-center mx-auto">
            <?php if(Auth::guest()): ?>
                <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                    <a class="topbar-link topmenu-item-color" href="<?php echo e(URL::to('/start-selling')); ?>"><?php echo e(Helper::translation(3018,$translate)); ?></a>
                </div>

                <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                    <a class="topbar-link topmenu-item-color" href="<?php echo e(URL::to('/start-selling')); ?>"><?php echo e(Helper::translation(3018,$translate)); ?></a>
                </div>

                <?php if($allsettings->site_blog_display == 1): ?>
                    <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                        <a class="topbar-link topmenu-item-color" href="<?php echo e(URL::to('/blog')); ?>"><?php echo e(Helper::translation(2877,$translate)); ?></a>
                    </div>
                    <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                        <a class="topbar-link topmenu-item-color" href="<?php echo e(URL::to('/blog')); ?>"><?php echo e(Helper::translation(2877,$translate)); ?></a>
                    </div>
                ...
                <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                    <a class="topbar-link topmenu-item-color" href="<?php echo e(URL::to('/contact')); ?>"><?php echo e(Helper::translation(2910,$translate)); ?></a>
                </div>
                <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                    <a class="topbar-link topmenu-item-color" href="<?php echo e(URL::to('/contact')); ?>"><?php echo e(Helper::translation(2910,$translate)); ?></a>
                </div>
                ...
                <?php if($count_help != 0): ?>
                    ...
                    <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                        <a class="topbar-link topmenu-item-color" href="<?php echo e(URL::to('/page/')); ?>/<?php echo e($help['page']->page_id); ?>/<?php echo e($help['page']->page_slug); ?>"><?php echo e($help['page']->page_title); ?></a>
                    </div>
                    <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                        <a class="topbar-link topmenu-item-color" href="<?php echo e(URL::to('/page/')); ?>/<?php echo e($help['page']->page_id); ?>/<?php echo e($help['page']->page_slug); ?>"><?php echo e($help['page']->page_title); ?></a>
                    </div>
                ...
                <?php if($allsettings->multi_language == 1): ?>
                    <div class="topbar-text dropdown d-md-none dropdown_1" style="padding-right:20px;">
                        <button class="dropbtn" data-toggle="dropdown"><?php echo e($language_title); ?></button>
                    ...
                    <div class="topbar-text text-nowrap d-none d-md-inline-block dropdown_1" style="padding-right:20px;">
                        <button class="dropbtn" data-toggle="dropdown"><?php echo e($language_title); ?></button>
                        <div class="dropdown-content_1">
                            <?php $__currentLoopData = $languages['view']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                <a href="<?php echo e(URL::to('/translate')); ?>/<?php echo e($language->language_code); ?>"><?php echo e($language->language_name); ?></a>
            ...
            <?php if(Auth::check()): ?>
                ...
                <?php if($count_help != 0): ?>
                    <?php if($help['page']->page_status == 1 && $help['page']->main_menu == 1): ?>
                    <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                        <a class="topbar-link" href="<?php echo e(URL::to('/page/')); ?>/<?php echo e($help['page']->page_id); ?>/<?php echo e($help['page']->page_slug); ?>"><?php echo e($help['page']->page_title); ?></a>
                    </div>
                    <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                        <a class="topbar-link" href="<?php echo e(URL::to('/page/')); ?>/<?php echo e($help['page']->page_id); ?>/<?php echo e($help['page']->page_slug); ?>"><?php echo e($help['page']->page_title); ?></a>
                    </div>
                    ...
                    <?php if(Auth::check()): ?>
                        <div class="navbar-tool dropdown ml-2">
                            <a class="navbar-tool-icon-box border dropdown-toggle" 
                                ...
                                <?php else: ?> 
                                    href="<?php echo e(url('/profile-settings')); ?>" 
                                <?php endif; ?>
                            >         
                                ...
                                <div class="widget widget-cart px-3 pt-2 pb-3">
                                        ...
                                        <?php $__currentLoopData = $cartitem['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="widget-cart-item pb-2 mb-2 border-bottom">
                                                ...
                                                <div class="media align-items-center">
                                                    <a class="d-block mr-2" href="<?php echo e(url('/item')); ?>/<?php echo e($cart->product_slug); ?>">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div class="widget-product-meta">
                                                            <span class="text-accent mr-2"><?php echo e($allsettings->site_currency); ?> <?php echo e($cart->product_price); ?></span>
                                                        </div>
                                                        <div class="cat">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                                        <div class="font-size-sm mr-2 py-2">
                                            ...
                                            <span class="text-accent font-size-base ml-1"><?php echo e($subtotal); ?> <?php echo e($allsettings->site_currency); ?></span>
                                        </div>
...
<?php /**PATH C:\xampp\htdocs\wrappixels\resources\views/header.blade.php ENDPATH**/ ?>