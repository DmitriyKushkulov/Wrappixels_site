...
<script src="<?php echo e(asset('public/assets/theme/plugins/owl-carousel/owl.carousel.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/theme/plugins/owl-carousel/owl-carousel.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/theme/cookie/cookiealert.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/main.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/map.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/custom.js')); ?>"></script>


<script src="<?php echo e(asset('public/assets/theme/js/vendor.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/theme/js/theme.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/theme/validate/jquery.bvalidator.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/theme/validate/themes/presenters/default.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/theme/validate/themes/red/red.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/theme/pagination/pagination.js')); ?>"></script>
<script type="text/javascript">
    $(document).ready(function() {
      $(this).cPager({
...
<script src="<?php echo e(asset('public/assets/theme/share/share.js')); ?>"></script> 
<script type="text/javascript">
...
<script src="<?php echo e(asset('public/assets/filter/jplist.core.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/filter/jplist.sort-bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/filter/jplist.textbox-filter.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/filter/jplist.filter-toggle-bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/filter/jplist.pagination-bundle.min.js')); ?>"></script>
...
<?php endif; ?>
<script src="<?php echo e(asset('public/assets/lightbox/topbox.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(URL::to('public/assets/theme/countdown/jquery.countdown.js?v=1.0.0.0')); ?>"></script>

<script src="<?php echo e(URL::to('resources/views/assets/custom.js')); ?>"></script>

<script type="text/javascript" src="<?php echo e(URL::to('public/assets/theme/animate/aos.js')); ?>"></script>
<script>
      AOS.init({
        easing: 'ease-in-out-sine'
      });
</script><?php /**PATH C:\xampp\htdocs\wrappixels\resources\views/javascript.blade.php ENDPATH**/ ?>