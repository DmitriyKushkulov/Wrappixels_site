            ...
            <div class="col-md-2 offset-md-1">
                <ul class="breadcrumb">
                    ...
                    <li class="active" style="list-style:none;">
                        <a class="text-white line-height-base" href="<?php echo e(URL::to('/shop')); ?>"><?php echo e(Helper::translation(3025,$translate)); ?></a>
                    </li>
                </ul>
            </div>
            ...
            <?php if(count($itemData['item']) != 0): ?>
                <div class="list items" id="listShow">
                    <?php $__currentLoopData = $itemData['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="product product--list product--list-small  li-item list-item product-card-alt" data-price="<?php echo e($item->regular_price); ?>">

                            <div class="product-thumb product__thumbnail">
                                <div class="product-card-actions">
                                    <!-- <a class="btn btn-light btn-icon btn-shadow font-size-base mx-2 transparent btn--sm btn--round" href="<?php echo e(URL::to('/item')); ?>/<?php echo e($item->item_slug); ?>/<?php echo e($item->item_id); ?>"><?php echo e(Helper::translation(2999,$translate)); ?></i></a> -->
                                    <a class="btn btn-light btn-icon btn-shadow btn--sm btn--round" href="<?php echo e(URL::to('/item')); ?>/<?php echo e($item->item_slug); ?>/<?php echo e($item->item_id); ?>"><?php echo e(Helper::translation(2999,$translate)); ?></i></a>
                                    <a class="btn btn-light btn-icon btn-shadow btn--sm btn--round" href="<?php echo e(url('/preview')); ?>/<?php echo e($item->item_slug); ?>/<?php echo e($item->item_id); ?>" target="_blank"><?php echo e(Helper::translation(3000,$translate)); ?></a>
                                </div>
                            ...
                            <div class="product__details">
                                <div class="product-desc">
                                    ...
                                    <ul class="titlebtm">
                                        <li class="product_cat">
                                            <a href="<?php echo e(URL::to('/shop')); ?>/item-type/<?php echo e($item->item_type); ?>" class="theme-color product-meta font-weight-medium">
                                ...
                                <div class="product-meta">
                                    ...
                                    <div class="love-comments">
                                        <p>
                                            <span class="lnr lnr-heart"></span> <?php echo e($item->item_liked); ?> likes
                                        </p>
                                    </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\wrappixels\resources\views/shop-list.blade.php ENDPATH**/ ?>