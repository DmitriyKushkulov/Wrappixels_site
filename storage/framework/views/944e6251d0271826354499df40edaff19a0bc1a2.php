        ...
        <div class="container content_above mb-lg-3 pb-4 pt-5">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <?php echo e(Helper::translation(2932,$translate)); ?>
                ...
                <div class="col-md-2 offset-md-1">
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="list-style:none;">
                            <a class="text-white line-height-base" href="<?php echo e(URL::to('/manage-item')); ?>"><?php echo e(Helper::translation(2932,$translate)); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\wrappixels\resources\views/manage-item.blade.php ENDPATH**/ ?>