                    ...
                    <div class="col-md-8 offset-md-2 pb-4 pt-5">
                        <div class="search">
                            <div class="col-lg-9 col-md-12 text-center mx-auto pb-4">
                                <h3 class="text-white line-height-base"><?php echo e(Helper::translation(2993,$translate)); ?></h3>
                                <h4 class="h4 text-white font-weight-light"><?php echo e(Helper::translation(2994,$translate)); ?></h4>
                            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\wrappixels\resources\views/flash-sale.blade.php ENDPATH**/ ?>