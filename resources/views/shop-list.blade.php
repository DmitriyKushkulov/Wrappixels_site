                        ...
                        <div class="product product--list product--list-small  li-item list-item product-card-alt" data-price="{{ $item->regular_price }}">
                            ...
                            <div class="product-thumb product__thumbnail">
                                <div class="product-card-actions">
                                    <!-- <a class="btn btn-light btn-icon btn-shadow font-size-base mx-2 transparent btn--sm btn--round" href="{{ URL::to('/item') }}/{{ $item->item_slug }}/{{ $item->item_id }}">{{ Helper::translation(2999,$translate) }}</i></a> -->
                                    <a class="btn btn-light btn-icon btn-shadow btn--sm btn--round" href="{{ URL::to('/item') }}/{{ $item->item_slug }}/{{ $item->item_id }}">{{ Helper::translation(2999,$translate) }}</i></a>
                                    <a class="btn btn-light btn-icon btn-shadow btn--sm btn--round" href="{{ url('/preview') }}/{{ $item->item_slug }}/{{ $item->item_id }}" target="_blank">{{ Helper::translation(3000,$translate) }}</a>
                                </div>
