                      ...
                      <div class="item-preview item-preview2">
                        ...
                        <div class="item__preview-thumb d-flex flex-wrap justify-content-between align-items-center border-top pt-3">
                                ...
                                <div class="action-btns py-2 mr-2">
                                    @if($item['item']->demo_url != '')<a href="{{ $item['item']->demo_url }}" class="btn btn-outline-accent btn-sm" target="_blank">{{ Helper::translation(3049,$translate) }}</a>@endif
                                    @if($getcount != 0)<a href="{{ url('/') }}/public/storage/items/{{ $item_image['item']->item_image }}" class="btn btn-outline-accent btn-sm" data-lightbox-gallery="mygallery">{{ Helper::translation(3050,$translate) }}</a>@endif
                                    @if(Auth::guest())
                            ...
                            <div class="accordion" id="licenses">
                                <div class="card border-top-0 border-left-0 border-right-0">
                                    <div class="card-header d-flex justify-content-between align-items-center py-3 border-0">
                                        ...
                                        <h5 class="mb-0 text-accent font-weight-normal">${{$item['item']->regular_price}}</h5>
                                    </div>
                                ...
                                <div class="card border-bottom-0 border-left-0 border-right-0">
                                    <div class="card-header d-flex justify-content-between align-items-center py-3 border-0">
                                        ...
                                        <h5 class="mb-0 text-accent font-weight-normal">${{$item['item']->extended_price}}</h5>
                                    </div>
