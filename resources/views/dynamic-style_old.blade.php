...
.btn-primary
{
color:#fff;background-color:#1a8b0b;border-color:#1a8b0b;box-shadow:none;
}
.btn-primary:hover
{
...
.ui-widget-content
{
border:1px solid #1a8b0b !important;
}
.link-color
{
color:#1a8b0b !important;
...
.form-control:focus{color:#4b566b;background-color:#fff;border-color:#1a8b0b !important;outline:0;}
.bg-primary{background-color:#1a8b0b !important}a.bg-primary:hover,a.bg-primary:focus,button.bg-primary:hover,button.bg-primary:focus{background-color:#29368b !important}
...
.navbar-light .navbar-nav .show>.nav-link,.navbar-light .navbar-nav .active>.nav-link,.navbar-light .navbar-nav .nav-link.show,.navbar-light .navbar-nav .nav-link.active{color:#1a8b0b;}
.navbar-light .navbar-nav .nav-link:hover,.navbar-light .navbar-nav .nav-link:focus{color:#1a8b0b;}
a:hover{color:#1a8b0b;text-decoration:none}
.dropdown-item:hover,.dropdown-item:focus{color:#1a8b0b;text-decoration:none;background-color:rgba(0,0,0,0)}.dropdown-item.active,.dropdown-item:active{color:#1a8b0b;text-decoration:none;background-color:rgba(0,0,0,0)}
.text-primary{color:#1a8b0b !important}
.dropdown-menu li:hover>.dropdown-item{color:#1a8b0b}.dropdown-menu .active>.dropdown-item{color:#1a8b0b}
.navbar-light .nav-item:hover .nav-link:not(.disabled),.navbar-light .nav-item:hover .nav-link:not(.disabled)>i{color:#1a8b0b;}.navbar-light .nav-item.active .nav-link:not(.disabled)>i,.navbar-light .nav-item.show .nav-link:not(.disabled)>i,.navbar-light .nav-item.dropdown .nav-link:focus:not(.disabled)>i{color:#1a8b0b;}
...
.topbar-dark .topbar-text>i,.topbar-dark .topbar-link>i{color:#1a8b0b}
...
.product-title>a:hover{color:#1a8b0b}
...
.turn-page .turn-ul li:hover, .turn-page .turn-ul li:active { background: #1a8b0b !important; color: #fff;}
.turn-page .turn-ul li.on { background: #1a8b0b !important; color: #fff;}
.btn-wishlist:hover{color:#1a8b0b}
/* .flash-sale .price-badge { background:#DE2F2F; color:#FFFFFF; } */
.price-badge { background:#DE2F2F; color:#FFFFFF; }
.widget-product-title:hover>a{color:#1a8b0b}
.blog-entry-title>a:hover{color:#1a8b0b}
.breadcrumb-item>a:hover{color:#1a8b0b;text-decoration:none}
.homeblog img {height:240px;object-fit:cover;width:100%;}
.bg-darker{background-color:#333333 !important}
a{color:#1a8b0b;text-decoration:none;background-color:transparent}
.display-404{color:#fff;font-size:10rem;text-shadow:-0.0625rem 0 #1a8b0b,0 0.0625rem #1a8b0b,0.0625rem 0 #1a8b0b,0 -0.0625rem #1a8b0b}
...
.range-price { border: 0; color: #1a8b0b !important; font-weight: bold; font-size: 16px; margin-bottom: 14px;}
...
.jplist-panel .jplist-pagination .jplist-current{color: #fff; background:#1a8b0b !important;}
...
{
background-color:#1a8b0b !important;
}
.nav-tabs .nav-link.active,.nav-tabs .nav-item.show .nav-link{color:#1a8b0b;background-color:rgba(0,0,0,0);border-color:#1a8b0b}
.nav-tabs .nav-link.active::before{background-color:#1a8b0b}
.nav-tabs .nav-link:hover{color:#1a8b0b}
.custom-control-input:checked ~ .custom-control-label::before{color:#fff;border-color:#1a8b0b;background-color:#1a8b0b;box-shadow:none}
...
.nav-link-style:hover{color:#1a8b0b;}
.cz-range-slider-ui .noUi-connect{background-color:#1a8b0b}
