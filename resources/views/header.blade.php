        ...
        <div class="container">
            ...
            @if(Auth::guest())
                <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                    <a class="topbar-link topmenu-item-color" href="{{ URL::to('/start-selling') }}">{{ Helper::translation(3018,$translate) }}</a>
                </div>
                ...
                @if($allsettings->site_blog_display == 1)
                    <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                        <a class="topbar-link topmenu-item-color" href="{{ URL::to('/blog') }}">{{ Helper::translation(2877,$translate) }}</a>
                    </div>
                    <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                        <a class="topbar-link topmenu-item-color" href="{{ URL::to('/blog') }}">{{ Helper::translation(2877,$translate) }}</a>
                    </div>
                ...
                <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                    <a class="topbar-link topmenu-item-color" href="{{ URL::to('/contact') }}">{{ Helper::translation(2910,$translate) }}</a>
                </div>
                <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                    <a class="topbar-link topmenu-item-color" href="{{ URL::to('/contact') }}">{{ Helper::translation(2910,$translate) }}</a>
                </div>
                ...
                @if($count_help != 0)
                    ...
                    <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                        <a class="topbar-link topmenu-item-color" href="{{ URL::to('/page/') }}/{{ $help['page']->page_id }}/{{ $help['page']->page_slug }}">{{ $help['page']->page_title }}</a>
                    </div>
                    <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                        <a class="topbar-link topmenu-item-color" href="{{ URL::to('/page/') }}/{{ $help['page']->page_id }}/{{ $help['page']->page_slug }}">{{ $help['page']->page_title }}</a>
                    </div>
                ...
                @if($allsettings->multi_language == 1)
                    <div class="topbar-text dropdown d-md-none dropdown_1" style="padding-right:20px;">
                        <button class="dropbtn" data-toggle="dropdown">{{ $language_title }}</button>
            ...
            @if (Auth::check())
                ...
                @if($count_help != 0)
                    @if($help['page']->page_status == 1 && $help['page']->main_menu == 1)
                    <div class="topbar-text dropdown d-md-none" style="padding-right:20px;">
                        <a class="topbar-link" href="{{ URL::to('/page/') }}/{{ $help['page']->page_id }}/{{ $help['page']->page_slug }}">{{ $help['page']->page_title }}</a>
                    </div>
                    <div class="topbar-text text-nowrap d-none d-md-inline-block" style="padding-right:20px;">
                        <a class="topbar-link" href="{{ URL::to('/page/') }}/{{ $help['page']->page_id }}/{{ $help['page']->page_slug }}">{{ $help['page']->page_title }}</a>
                    </div>
                                ...
                                <div class="widget widget-cart px-3 pt-2 pb-3">
                                                ...
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div class="widget-product-meta">
                                                            <span class="text-accent mr-2">{{ $allsettings->site_currency }} {{ $cart->product_price }}</span>
                                                        </div>
                                                        <div class="cat">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                                        <div class="font-size-sm mr-2 py-2">
                                            ...
                                            <span class="text-accent font-size-base ml-1">{{ $subtotal }} {{ $allsettings->site_currency }}</span>
                                        </div>
